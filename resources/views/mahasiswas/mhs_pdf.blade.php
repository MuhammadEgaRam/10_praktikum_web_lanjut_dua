        ...
        <div class="row justify-content-center align-items-center">
            <div style="text-align:center">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group"><b>Nama  : </b>{{$mahasiswas->Nama}}</li>
                    <li class="list-group"><b>Nim   : </b>{{$mahasiswas->Nim}}</li>
                    <li class="list-group"><b>Kelas : </b>{{$mahasiswas->kelas->nama_kelas}}</li>
                </ul><br>
